...
- `pitchRx::scrape()` pulls all PITCHf/x data for a particular date range
...
- Specifically:
    1. How many pitches do umpires see during games? Of those, how many require an umpire decision?
    2. How accurate are umpires given pitch count and location?
    3. Does umpire accuracy change from week to week over the course of the season?
...
## Contextual Umpire Accuracy
- Text

## Cumulative Umpire Accuracy
- Text
